import type { FixedTuple, Maybe, Nullable, Range } from 'extended-utility-types';
import type {
	GuildMember,
	Invite,
	InviteMetadata,
...
export interface Channel extends PartialChannel {
	...
	/**
	 * - **Guild Channels:** ID of the parent category for a channel (each parent category can
	 * contain up to 50 channels).
	 * - **Threads:** ID of the text channel this thread was created.
	 */
